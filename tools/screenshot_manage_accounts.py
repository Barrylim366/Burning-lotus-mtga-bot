...
class FakeCM:
    ...
    def get_managed_accounts(self): return [
        {'name': 'TEUBAT', 'email': 'giacomo.joghurt@web.de', 'pw': 'secret', 'folder': ''},
        {'name': 'Affinity2004', 'email': 'giacomoj92@gmail.com', 'pw': 'pass', 'folder': ''},
        {'name': 'Ayayill', 'email': 'giacogispower@gmail.com', 'pw': 'pass', 'folder': ''},
    ]
    def get_account_play_order(self): return ['Ayayill', 'Affinity2004', 'TEUBAT', '', '', '', '', '', '', '']
