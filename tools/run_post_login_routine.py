...
LOG_PATH = str(runtime_file("logs", "post_login_test.log"))
...
def main():
    ...
    repo_root = str(Path(__file__).resolve().parent.parent if Path(__file__).resolve().parent.name == "tools" else Path(__file__).resolve().parent)
